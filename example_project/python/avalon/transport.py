...
class Transport:
    ...
    def data_received(self, data):
        ...
        # self.rx_pktData = self.handle_data(self.rx_pktData)
    ...
    def packet_channel_send_packet(self, data_buffer=bytearray(), channel_number=-1):
    ...
    def transaction_channel_write(self, addr,  channel_number=-1, data_buffer=bytearray(), transaction=AvalonBus.LOOP_BACK, length=-1):
    ...
    def transaction_channel_read(self, addr, channel_number=-1, burst_length=4, transaction=AvalonBus.LOOP_BACK):
    ...
    def do_transaction(self, trans_type, address, channel_number=-1, data=bytearray(), length=-1):
        """
