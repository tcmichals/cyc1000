...
module avalonBus_mm_interconnect_0_router_default_decode
  #(
...
module avalonBus_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    avalonBus_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x50 .. 0x60 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 8'h50  && write_transaction  ) begin
            src_channel = 6'b001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x60 .. 0x68 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 8'h60  && read_transaction  ) begin
    ...
    // ( 0xc0 .. 0xe0 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 8'hc0  && write_transaction  ) begin
